...
deps = {
  ...
  "components/brave_extension/extension/brave_extension": "https://github.com/brave/brave-extension.git@385e580507125b7aa91b6e34fcb8e90c58b8c96a",
...
hooks = [
  ...
  {
    # Run npm install for brave_extension
    'name': 'init',
    'condition': 'not checkout_android',
    'pattern': '.',
